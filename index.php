               ...
               <div class="col-md-12 p-5 bg-white full-height">
                  <div class="login-main-left">
                     <div class="text-center mb-5 login-main-left-header pt-4">
                        ...
                        <h5 class="mt-3 mb-3">Bienvenido a $title reproductor IPTV</h5>
                      ...
                      <form method="post" action="watch.php" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                           <div class="row">
                              <div class="col-12">
                                 <button type="submit" name="submit" class="btn btn-outline-primary btn-block btn-lg">Ver</button>
                              </div>
                           </div>
                        </div>
                     <div class="text-center mt-5">
                       <!-- <p class="light-gray">Don’t have an account? <a href="register.html">Registrarse</a></p> -->
                     </div>
                      </form>
                  </div>
               </div>
